...
public interface ITaskRepository : IRepository
{
    ...
    Task<TaskEntity> GetByIdAsync(Guid planId, Guid id, CancellationToken cancellationToken = default);
    ...
    Task DeleteAsync(Guid planId, Guid id, CancellationToken cancellationToken = default);
}